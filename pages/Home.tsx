    ...
    <div className="pb-24 md:pb-32">
      ...
      <section className="relative h-[85vh] md:h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-30 text-center px-5 md:px-4 max-w-5xl mx-auto flex flex-col items-center gap-5 md:gap-8 animate-fade-in-blur">
          <div className="inline-flex items-center gap-2 md:gap-3 px-4 md:px-6 py-1.5 md:py-2 border border-white/10 rounded-full text-[8px] md:text-[9px] tracking-[0.4em] md:tracking-[0.5em] uppercase text-pudava-primary font-bold backdrop-blur-2xl bg-white/5 shadow-2xl">
      ...
      <section className="container mx-auto px-4 md:px-6 py-12 md:py-32">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 md:mb-20 gap-4 md:gap-8">
          <div className="reveal-container">
            <span className="text-pudava-primary font-black tracking-[0.3em] md:tracking-[0.4em] uppercase text-[8px] md:text-[9px] mb-1 md:mb-2 block">Curation</span>
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 md:bottom-12 md:left-12">
              <div className="flex items-center gap-2 md:gap-3 mb-1 md:mb-3">
                ...
                <span className="text-[8px] md:text-[10px] tracking-[0.3em] md:tracking-[0.4em] uppercase text-pudava-primary font-black">Empress Series</span>
              </div>
      ...
      <div className="w-full py-6 md:py-12 overflow-hidden border-y border-white/5 backdrop-blur-3xl bg-white/[0.02]">
        <div className="flex gap-12 md:gap-24 whitespace-nowrap overflow-x-auto no-scrollbar px-4 md:px-12">
          {["Artisan Silk", "Hand-Embroidered", "Midnight Velvet", "Sustainable Luxe", "Ethically Sourced"].map((item, i) => (
            <div key={i} className="flex items-center gap-3 md:gap-6 text-pudava-primary/40 uppercase tracking-[0.4em] md:tracking-[0.6em] text-[8px] md:text-[10px] font-black italic">
          ...
          {bestSellers.map((product, idx) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden rounded-lg md:rounded-[2rem] mb-3 md:mb-6">
                ...
                <div className="absolute top-3 right-3 md:top-6 md:right-6 bg-white/10 backdrop-blur-2xl border border-white/10 rounded-full p-2 md:p-3 text-white hover:bg-pudava-primary transition-colors btn-press">
                  <Heart size={14} />
                </div>
              </div>
              <div className="px-1 md:px-3">
                <span className="text-[8px] md:text-[9px] text-pudava-primary font-black uppercase tracking-[0.2em] md:tracking-[0.3em] mb-1 md:mb-2 block">{product.category}</span>
                ...
                <div className="mt-2 md:mt-4 pt-2 md:pt-4 border-t border-white/5 flex justify-between items-center">
                  <span className="text-[8px] md:text-xs text-gray-500 hidden md:block">Retail Value</span>
