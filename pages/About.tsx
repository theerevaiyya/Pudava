...
export const About: React.FC = () => {
    return (
        <div className="container mx-auto px-4 py-8 mt-16 mb-20 md:mb-0">
            <GlassCard className="max-w-4xl mx-auto p-8 md:p-12">
                <h1 className="text-4xl font-bold mb-6 text-center">The Pudava Story</h1>
                <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
                    ...
                    <div className="my-8 h-64 rounded-xl overflow-hidden relative">
                         <img 
