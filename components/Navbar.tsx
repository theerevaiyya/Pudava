...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <nav 
        className={`hidden md:flex fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b border-transparent ${
          scrolled ? 'bg-pudava-bg/90 backdrop-blur-md border-white/5 py-3' : 'bg-transparent py-5'
        }`}
      >
      ...
      <nav className="md:hidden fixed bottom-4 left-4 right-4 z-50">
        <div className="glass-panel rounded-2xl px-6 py-2 flex justify-between items-center shadow-2xl shadow-black/50">
